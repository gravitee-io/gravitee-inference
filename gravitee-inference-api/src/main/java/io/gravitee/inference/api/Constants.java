...
public final class Constants {
  ...
  */
  ...
  public static final String SERVICE_INFERENCE_MODELS_CREATE = "service:inference:models:create";
  public static final String SERVICE_INFERENCE_MODELS_INFER_TEMPLATE = "service:inference:models:%s:infer";
